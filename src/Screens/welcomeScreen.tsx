        ...
        <View style={{height:"100%"}}>
          ...
          <View style={styles.middleView}>
            ...
            <View style={{marginVertical:17}}>
                ...
                <Text style={styles.middleText}>Make sure your photos, age and bio are true to who you are.</Text>
            </View>
            ...
            <View style={{marginVertical:17}}>
                ...
                <Text style={styles.middleText}>Don't be too quick to give out personal information.</Text>
            </View>
            ...
            <View style={{marginVertical:17}}>
                ...
                <Text style={styles.middleText}>Respect others and treat them as you would like to be treated.</Text>
            </View>
           ...
           <ButtonComponent buttonName = "I AGREE"  Btn={{marginBottom:23}} />
